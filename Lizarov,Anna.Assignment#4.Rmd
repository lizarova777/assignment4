...
```{r}
# Answer: One would not have lost important information about mean_correct if components with a small proportion of variance would have been dropped because these omitted components do not have any effect on the reconnstruction error as they do not account for much.  In other words, they do not really maximize the variance. 
```
